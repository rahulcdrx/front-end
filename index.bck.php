            ...
            <div class="row property-filter">
                <div class="col-lg-4 col-md-6 mix all house">
                    <div class="property-item">
                        <div class="pi-pic set-bg" data-setbg="img/artist/artist1.jpg">
                        ...
                        <div class="pi-text">
                           ...
                           <center><a href="./property-details.php" class="primary-btn" style="color:#fff;">View Profile</a></center>
                ...
                <div class="col-lg-4 col-md-6 mix all restaurent hotel">
                    <div class="property-item">
                        <div class="pi-pic set-bg" data-setbg="img/artist/artist2.jpg">
                            <div class="label c-red">For Hire</div>
                        </div>
                        <div class="pi-text">
                            <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                ...
                <div class="col-lg-4 col-md-6 mix all apart office">
                    <div class="property-item">
                         <div class="pi-pic set-bg" data-setbg="img/artist/artist3.jpg">
                            <div class="label c-red">For Hire</div>
                        </div>
                        <div class="pi-text">
                            <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                ...
                <div class="col-lg-4 col-md-6 mix all hotel restaruent">
                    <div class="property-item">
                         <div class="pi-pic set-bg" data-setbg="img/artist/artist4.jpg">
                            <div class="label c-red">For Hire</div>
                        </div>
                        <div class="pi-text">
                            <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                ...
                <div class="col-lg-4 col-md-6 mix all office hotel">
                    <div class="property-item">
                       <div class="pi-pic set-bg" data-setbg="img/artist/artist5.jpg">
                            <div class="label c-magenta">For Hire</div>
                        </div>
                        <div class="pi-text">
                            <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                            <!-- <div class="pt-price">$ 289.0</div> -->
                ...
                <div class="col-lg-4 col-md-6 mix house apart office">
                    <div class="property-item">
                        <div class="pi-pic set-bg" data-setbg="img/artist/artist6.jpg">
                            <div class="label">For Hire</div>
                        </div>
                        <div class="pi-text">
                            <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
